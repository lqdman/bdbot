...
//     return;
//   }
//   updateUserState(chatId, null, { battleLink: msg.text });
...
// //   if (msg.text.startsWith('/')) return;
// //   updateUserState(chatId, 'awaitingPracticeDetails', { practiceName: msg.text });
// //   bot.sendMessage(chatId, messages[userData.language].addPracticeDetails);
// // }
...
//   // Отправка сообщения "Отлично, пост готов к публикации" с кнопкой
...
//     ]
//   };
//   bot.sendMessage(chatId, messages[language].postReady, { reply_markup: keyboard });
// }
...
// // Функция для обработки состояния 'awaitingBattleDescription'
// function handleAwaitingBattleDescriptionCallback(query, chatId, selectedValue, userData) {
...
// function publishToChannel(chatId, userData) {
//   const userLabels = getLabels(userData.language);
//   const description = userData.postData.battleDescription ? `${userLabels.description}: ${userData.postData.battleDescription}\n\n` : '';
...
//   bot.sendMessage(channelId, `${userLabels.title}: ${battleNameLink}\n—\n${userLabels.dates}: ${userData.postData.battleDates}\n${userLabels.city}: ${userData.postData.battleLocation}\n•••\n\n${description}\n\n${messages[userData.language].searchByTag} ${tags}`, {
//     reply_markup: {
//       inline_keyboard: inlineKeyboard
//     },
//     parse_mode: 'HTML'
...
//   switch (userData.state) {
//     case 'awaitingBattleDates':
//       handleAwaitingBattleDatesCallback(query, chatId, messageId, selectedValue, userData);
//       break;
//     case 'awaitingBattleMonth':
//       handleAwaitingBattleMonthCallback(query, chatId, messageId, selectedValue, userData);
//       break;
//     case 'awaitingBattleYear':
//       handleAwaitingBattleYearCallback(query, chatId, messageId, selectedValue, userData);
//       break;
//     case 'awaitingBattleDescription':
//       handleAwaitingBattleDescriptionCallback(query, chatId, selectedValue, userData);
//       break;
//     default:
//       if (selectedValue === 'publish') {
//         console.log('Publishing to channel...'); // Добавьте это для логирования
//         publishToChannel(chatId, userData);
//         bot.answerCallbackQuery(query.id, { text: 'Post published to channel!', show_alert: true });
//       }
//       break;
//   }
